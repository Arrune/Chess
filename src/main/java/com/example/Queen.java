...
public class Queen extends Piece {
    ...
    // Precondition: start is a square on the board containing this piece.
    // Postcondition: Returns an ArrayList of Squares that this piece can legally
    // move to,
    ...
    public ArrayList<Square> getLegalMoves(Board b, Square start) {
        ...
        while (row >= 0) {
            if (!b.getSquareArray()[row][start.getCol()].isOccupied()) {
                ...
                if (b.getSquareArray()[row][start.getCol()].getOccupyingPiece().getColor() != this.getColor()) {
                    moves.add(b.getSquareArray()[row][start.getCol()]);
                }
                break;
            }
        ...
        while (col < 8) {
            if (!b.getSquareArray()[start.getRow()][col].isOccupied()) {
                ...
                if (b.getSquareArray()[start.getRow()][col].getOccupyingPiece().getColor() != this.getColor()) {
                    moves.add(b.getSquareArray()[start.getRow()][col]);
                }
                break;
            }
        ...
        while (row >= 0 && col >= 0) {
            if (!b.getSquareArray()[row][col].isOccupied()) {
                ...
                if (b.getSquareArray()[row][col].getOccupyingPiece().getColor() != this.getColor()) {
                    moves.add(b.getSquareArray()[row][col]);
                }
                break;
            }
